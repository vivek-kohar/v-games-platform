...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      {/* Animated Background */}
      <div className="absolute inset-0 bg-gray-900/20 opacity-20" 
           style={{
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-white">V-Games Platform</h1>
            ...
            <div className="flex items-center space-x-4">
              ...
              <Button
                ...
                className="flex items-center space-x-2 bg-red-500/10 border-red-500/20 text-red-400 hover:bg-red-500/20"
              >
